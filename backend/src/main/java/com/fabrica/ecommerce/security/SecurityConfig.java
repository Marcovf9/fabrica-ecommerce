...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/api/products/catalog", "/api/products/categories", "/api/meta/catalog.xml").permitAll()
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList(
            "http://localhost:5173",
            "https://guileless-basbousa-a70f51.netlify.app",
            "https://ritualespacios.com",
            "https://www.ritualespacios.com"
        ));
