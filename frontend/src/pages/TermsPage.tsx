    ...
    <>
      ...
      <div className="max-w-4xl mx-auto py-16 px-4 md:px-8">
        <div className="text-center mb-12">
          ...
          <h1 className="text-3xl text-brand-dark font-light uppercase tracking-widest mb-4">Términos y Condiciones</h1>
          <p className="text-brand-muted">Políticas comerciales y marco legal de operación.</p>
        </div>
        <div className="bg-white p-8 md:p-12 rounded-xl border border-brand-border shadow-sm text-brand-muted space-y-8 leading-relaxed">
          <section>
            <h2 className="text-xl font-bold text-brand-dark uppercase tracking-wider mb-4">1. Validez de Cotizaciones y Precios</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-brand-dark uppercase tracking-wider mb-4">2. Responsabilidad Logística</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-brand-dark uppercase tracking-wider mb-4">3. Políticas de Devolución</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-brand-dark uppercase tracking-wider mb-4">4. Propiedad Intelectual</h2>
